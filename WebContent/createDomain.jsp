	...
	<script>
		...
		function sendRequest() {
			...
			try {
				...
				http.send('name=' + name+'&throughput='+throughput+'&host='+host);		
			} catch(e) {
				alert(e);
			}
		}
...
<div style="position:absolute; top:60px; width:800px; height:600px; border: 1px solid #000000;">
	<table>
		...
		<tr>
			...
			<td>
				<input style="width:700px;" type="text" id="uri" value="http://localhost:8080/barney/restlet/domain/{domainID}"></input>
			</td>
		</tr>
<tr>
			<td>
			...
			<td>
				<input style="width:700px;" type="text" id="name" value="Domain Name"></input>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input style="width:700px;" type="text" id="throughput" value="MySQL"></input>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input style="width:700px;" type="text" id="host" value="dummy"></input>
			</td>
		</tr>
		<tr>
			<td>
